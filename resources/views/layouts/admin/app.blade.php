...
<head>
    ...
    <style>
        ...
        nav {
            ...
            color: #ffffff;
            box-shadow: 0 4px 6px rgba(76, 82, 100, 0.1);
            cursor: default;
        }
...
<body class="antialiased min-h-screen lg:flex" x-data="{open: false}">
    <nav class="absolute inset-0 transform lg:transform-none lg:opacity-100 duration-200 lg:relative z-10 w-80 bg-indigo-900 text-white h-screen p-3"
        ...
        <ul class="mt-8">
            <li>
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <a :href="route('logout')"
                        class="block px-4 py-2 hover:bg-gray-600 rounded-md cursor-pointer"
